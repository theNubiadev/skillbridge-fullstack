  ...
  const recentJobs = [
    {
      ...
      budget: "$2000-$5000",
      description:
        "Looking for a developer to build a modern e-commerce platform with React and Node.js",
    ...
    },
    {
      ...
      budget: "$1000-$3000",
      description:
        "Need a talented designer to create intuitive UI for our fitness tracking app",
      ...
      <section className="relative py-20 px-4 overflow-hidden bg-white">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
            SkillBridge is the premier platform where talented freelancers meet
            ambitious clients.
          </p>
